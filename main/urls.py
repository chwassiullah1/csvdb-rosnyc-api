...
path('update_status/', views.UpdateStatusAPIView.as_view(), name='update_status'),
...
path('jobs/<int:pk>/', views.JobViewSet.as_view(), name='jobs'),
...
path('units/<int:job_id>/', views.UnitsByJobId.as_view(), name='get_units_by_job_id'),
