...
path('getFilteredProps/', views.FilteredPropertyView.as_view(), name='getFilteredProps'),
path('getPropsByIds/', views.GetPropsByIdsView.as_view(), name='getPropsByIds'),
...
path('job-units-status/<int:job_id>/', views.UnitJobStatusAPIView.as_view(), name='unit_job_status'),
path('unit/search', views.UnitSearchAPIView.as_view(), name='unit-filter'),
path('template-descriptions/', views.TemplateDescriptionListCreateView.as_view(), name='template-desc-list-create'),
path('template-descriptions/<int:pk>/', views.TemplateDescriptionRetrieveUpdateDestroyView.as_view(), name='del-template-detail'),
path('web-titles/', views.WebTitleListCreateView.as_view(), name='web-title-list-create'),
...
path("task/<str:task_id>/delete/", views.delete_automated_task, name="delete_task"),
path("task/<str:task_id>/pause/", views.pause_automated_task, name="pause_task"),
path("task/<str:task_id>/resume/", views.resume_automated_task, name="resume_task"),
